...
public static class ScheduleCommands
{
	...
	public static void GlobalDiscordCommand()
	{
	...
	public static void GlobalRankedHelpCommand()
	{
	...
	[CommandFramework.Command("testrendy", description: "Send a message to everyone for ranked", usage:".rankedhelp", adminOnly: true, includeInHelp: false, category: "Misc")]
